...
<div class="email-wrap">
  ...
  <div class="body">
    ...
    <p class="lead">
      ...
      "<strong>{{ $ticket->subject }}</strong>". Please visit the workspace to review and reply.
    </p>
    ...
    <p class="hint">
      ...
      <strong>{{ $ticket->department }}</strong> department. Replies must be posted in the workspace
      (this inbox doesn't track responses) &mdash; do not reply to this email.
    </p>
  </div>

  <div class="footer">
    © {{ date('Y') }} EIAAW Workforce &bull; Automated notification.
  </div>
</div>
</body>
</html>
