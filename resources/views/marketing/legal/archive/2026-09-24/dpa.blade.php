...
@section('legal-archive-notice')
    <p style="background:var(--bg-warm);border:1px solid var(--line-soft);border-radius:12px;padding:12px 16px;font-size:14px;">Superseded version, kept for reference. It applied from 24 September 2026 until 25 September 2026. <a href="{{ route('marketing.dpa') }}">Read the current version.</a></p>
@endsection
